...
function setOnlineStatus(id, value) {
    return __awaiter(this, void 0, void 0, function* () {
        yield usuario_2.default.updateOne({ "_id": id }, { $set: { "online": value } });
    });
}
exports.default = { getAllUsuarios, getUsuario, getUsuarioByEmail, newUsuario, updateUsuario, deleteUsuario, LogIn, setOnlineStatus };
